#include "postfix_Operators_and_Operands_definitions.c"
...
int main(){
	...
	*/
	...
	ExpressionTestCase tests[] ={
		...
		{"( 0.1 4 .2 ^ / 5.7 +)sqrt"		,"2.403286"},
		{"5 4 sqrt +"					,"7.000000"},
		{"5 (4)sqrt +"				,"7.000000"},
		{"4 .2 ^ (0.1) sqrt / 5.7 +"	,"5.939656"},
		{"4 .2 ^ 0.1 sqrt / 5.7 +"	,"5.939656"},
		{"( 0.1 4 ^ .2 / 5.7 +)sqrt"		,"2.387572"},
		{"Z I + I +"				,"2.000000"},
		{"Z I+I+"					,"2.000000"},
		{"1 2 3 trisum"				,"6.000000"},
		{"(1,2,3)trisum"			,"6.000000"},
		{"(1,2,3,4)trisum"			,"evaluate_ExpressionTree(NULL)"},
		{"((1,2,3))trisum"			,"6.000000"},
		{"((1,2),3)trisum"			,"6.000000"},
		{"(1,(2,3))trisum"			,"6.000000"},
		{"(1,(2),3)trisum"			,"6.000000"},
		...
		{"((1,2,3),4)trisum"		,"evaluate_ExpressionTree(NULL)"},
		{"(1,(2,3,4))trisum"		,"evaluate_ExpressionTree(NULL)"},
		{"1(2, 3)trisum"			,"evaluate_ExpressionTree(NULL)"},
		{" (1,2)3 trisum"			,"evaluate_ExpressionTree(NULL)"},
		{" 1 (2, 3) trisum"			,"6.000000"},
		{"(1,2) 3trisum "			,"6.000000"},
		{"(1,(2,3,4))tetrasum"		,"10.000000"},
		{"(1,2,(3,4))tetrasum"		,"10.000000"},
		{"(1,(2,3),4)tetrasum"		,"10.000000"},
		{"((1,2),(3,4))tetrasum"	,"10.000000"},
		{"2 2+","3.000000"}
