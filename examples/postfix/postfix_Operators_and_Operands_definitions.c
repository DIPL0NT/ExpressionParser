...
const Operator sumOp  	  = {"+"	 	 ,2     ,POSTFIX ,0          , sumFunc		};
const Operator subOp  	  = {"-"	 	 ,2     ,POSTFIX ,0          , subFunc		};
const Operator multOp 	  = {"*"	 	 ,2     ,POSTFIX ,0          , multFunc		};
const Operator divOp  	  = {"/"     	 ,2     ,POSTFIX ,0          , divFunc		};
const Operator sqrtOp 	  = {"sqrt"	 	 ,1     ,POSTFIX ,0          , sqrtFunc		};
const Operator powOp  	  = {"^"	 	 ,2     ,POSTFIX ,0          , powFunc		};
const Operator zeroOp 	  = {"Z"	 	 ,0     ,POSTFIX ,0          , zeroFunc		};
const Operator oneOp  	  = {"I"	 	 ,0     ,POSTFIX ,0          , oneFunc		};
const Operator trisumOp   = {"trisum"	 ,3     ,POSTFIX ,0          , trisumFunc	};
const Operator tetrasumOp = {"tetrasum"	 ,4     ,POSTFIX ,0          , tetrasumFunc	};
